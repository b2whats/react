		...
		return (
          ...
          { _.map([
	          ...
	          <WorkDaysBlock
				...
				<div className="m20-0">
					<button onClick={this.submit_form} disabled={!this.state.address || !(this.state.phones.get(0).length > 10)} className="grad-ap btn-shad b0 c-wh fs16 br3 p8-20">Сохранить</button>
				</div>
			</div>
		);
		/* jshint ignore:end */
