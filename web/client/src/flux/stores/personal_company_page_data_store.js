...
var cncl_ = [
  ...
  .on(event_names.kON_CATALOG_SHOW_ALL_PHONES_ON_CURRENT_PAGE, value => {
    ...
    personal_company_page_data_store.fire(event_names.kON_CHANGE);
...
var personal_company_page_data_store = merge(Emitter.prototype, {
...
module.exports = personal_company_page_data_store;
