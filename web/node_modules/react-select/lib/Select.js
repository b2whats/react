  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        value,
        React.createElement(Input, { className: "Select-input", tabIndex: this.props.tabIndex, ref: "input", value: this.state.inputValue, onFocus: this.handleInputFocus, onBlur: this.handleInputBlur, onChange: this.handleInputChange, minWidth: "5", readOnly: this.props.readonly}),
