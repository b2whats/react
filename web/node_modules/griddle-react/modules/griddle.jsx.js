...
var Griddle = React.createClass({
  ...
  changeSort                : function (sort) {
    ...
    if (this.props.useExternal) {
      this.props.externalChangeSort(sort, this.props.externalSortColumn === sort ?
    ...
    return (
      React.createElement("div", {className : "griddle-footer"},
        this.props.useCustomPagerComponent ?
          React.createElement(CustomPaginationContainer, {
            next                 : this.nextPage,
  ...
  getCustomGridSection      : function () {
    return React.createElement(this.props.customGridComponent, {
    ...
    return (
      React.createElement("div", {className : gridClassName},
        ...
        React.createElement("div", {
            ...
            style     : this.props.useGriddleStyles && !this.props.isSubGriddle ?
