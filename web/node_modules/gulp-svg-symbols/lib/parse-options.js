...
var cssTmpl_size   = path.join(__dirname, '../templates/svg-symbols-size.css');
...
function handleDefaultTemplates(template) {
  switch (template) {
      case 'default-svg':
        template = svgTmpl;
        break;
      case 'default-css-size':
        template = cssTmpl_size;
        break;
      case 'default-css':
        template = cssTmpl;
        break;
...
module.exports = function (opts) {
  opts        = opts || {};
  // clone everything as we don't to mutate anything
