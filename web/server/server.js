...
_.each([
  '/', '/page/:id', '/catalog/:region_id', '/help', '/typeahead', '/sphere/:sphere_id', '/:id', '/find/:region_id/:sentence/:producer/:articul/:id', '/find/:region_id/:sentence/:producer/:articul/:id/:service/:service_auto_mark/:service_id'
  ],  function(route) {
