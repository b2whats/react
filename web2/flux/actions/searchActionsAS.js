...
const rAutoPartsData = resource(apiRefs.kAUTO_SERVICE_BY_ID_API);

const actions_ = [
  ['mapBoundsChange', eventNames.K_ON_SEARCH_MAP_BOUNDS_CHANGE_AS],
  ['visibleRowsChange', eventNames.K_ON_SEARCH_VISIBLE_ROWS_CHANGED_AS],
  ['rowHover', eventNames.K_ON_SEARCH_ROW_HOVER_AS],
