...
function renderPriceColumn(cellDataKey, rowData, rowIndex) {
  return (
    <div className={cx('fs12')}>
      <span className="fs18 m0-5 lh1">{rowData.getIn(['subject', 'retail_price']) | 0} р</span>
    </div>
  );
}
...
function renderComment() {
  return <span>Наименование детали</span>;
}
function renderMC() {
...
function renderPrice() {
  return <span className="d-ib"><span>Цена</span></span>;
}
function renderP() {
...
//console.log(11111111);
  return (
    <div className={cx('fs12 bB1s bc-grey-400')}>
      ...
      <Col height={40} cellRenderer={renderComment} rowIndex={1} className='bL1s bR1s bc-grey-400 bgc-grey-100 d-ib va-T fs13' {...newColumns[0]}/>
      <Col height={40} cellRenderer={renderMC} rowIndex={2} className='bR1s bc-grey-400  bgc-grey-100 d-ib va-T fs13' {...newColumns[1]}/>
      <Col height={40} cellRenderer={renderPrice} rowIndex={3} className='bR1s bc-grey-400  bgc-grey-100 d-ib va-T fs13' {...newColumns[2]}/>
      <Col height={40} cellRenderer={renderDate} rowIndex={5} className='bR1s bc-grey-400  bgc-grey-100 d-ib va-T fs13' {...newColumns[3]}/>
...
export function cellRenderer(cellDataKey, rowData, rowIndex) {
  ...
  case 'price':
    return renderPriceColumn(cellDataKey, rowData, rowIndex);
  case 'phone':
